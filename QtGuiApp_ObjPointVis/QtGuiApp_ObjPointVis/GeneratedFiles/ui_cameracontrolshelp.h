...
public:
    ...
    void setupUi(QWidget *CameraControlsHelp)
    {
        ...
        CameraControlsHelp->resize(416, 310);
        ...
        label_15->setGeometry(QRect(10, 190, 391, 31));
        label_15->setAlignment(Qt::AlignLeading|Qt::AlignLeft|Qt::AlignVCenter);
        label_16 = new QLabel(CameraControlsHelp);
        label_16->setObjectName(QStringLiteral("label_16"));
        label_16->setGeometry(QRect(10, 230, 401, 31));
        label_16->setAlignment(Qt::AlignLeading|Qt::AlignLeft|Qt::AlignVCenter);
        label_17 = new QLabel(CameraControlsHelp);
        label_17->setObjectName(QStringLiteral("label_17"));
        label_17->setGeometry(QRect(10, 260, 401, 31));
    ...
    void retranslateUi(QWidget *CameraControlsHelp)
    {
        ...
        label_15->setText(QApplication::translate("CameraControlsHelp", "Left Click: when create points is on: \n"
"new Point added at clicked object's intersection", Q_NULLPTR));
        label_16->setText(QApplication::translate("CameraControlsHelp", "(Middle Click OR Right Click) and drag: move camera in that direction", Q_NULLPTR));
        label_17->setText(QApplication::translate("CameraControlsHelp", "(Left Click) and drag: rotate camera in that direction", Q_NULLPTR));
    } // retranslateUi
